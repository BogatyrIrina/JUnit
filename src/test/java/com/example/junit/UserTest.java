...
public class UserTest {
    ...
    private static void initParams(){
        ...
        user1 = new User();
        user2 = new User("name", "myemail@mail.ru");
    }
    @AfterAll
    ...
    void shouldGetLogin() throws IllegalArgumentException {
        User user = new User("name", "myemail@mail.ru");
    ...
    public void shouldNotValidUserParametersTrowException(){
        Assertions.assertThrows (IllegalArgumentException.class, () -> new User("name", "myemail@mail.ru"));
    }
    @Test
